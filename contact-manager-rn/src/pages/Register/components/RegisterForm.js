   ...
   const disableButtonOnSubmit = () =>
    ...
    useEffect(() => {
      ...
      else if(registerResponse!="" || registerResponse!=null || registerResponse!="loading")
      {
        ...
        {
          ResponseToast("top","Close","success",registerResponse.messages,6000);
         
        }else if(registerResponse.success === false)
        {
            if(typeof registerResponse.messages === "string")
            {
              ResponseToast("top","Close","danger",registerResponse.messages,6000);
            }else if(typeof registerResponse.messages === "object")
            {
              Object.keys(registerResponse.messages).map((keys,index)=>{
          
                ResponseToast("top","Close","danger",registerResponse.messages[keys][0],6000);
              })
            }
        }
      }
    ...
    return (
        ...
        <View style={styles.container}  >
          ...
          <Formik  initialValues={fields}
            ...
            disabled={disable}
            >
              <Ionicons name="person-add" color="#fff" size={20} />
