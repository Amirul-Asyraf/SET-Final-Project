...
export default function CreateForm() {
 ...
 const LoadActionSheetForFile = () =>{
  ...
  const pickImage = async () => {
    ...
    console.log("This is result.uri: ",result.uri);
...
const disableButtonOnSubmit = () =>
 ...
 useEffect(() => {
  ...
  else if(createResponse!="" || createResponse!=null || createResponse!="loading")
  {
    ...
    {
      ResponseToast("top","Close","success",createResponse.messages,6000);
      console.log(createResponse.messages);
    ...
    {
        if(typeof createResponse.messages === "string")
        {
          ResponseToast("top","Close","danger",createResponse.messages,6000);
        ...
        {
          Object.keys(createResponse.messages).map((keys,index)=>{
      
            ResponseToast("top","Close","danger",createResponse.messages[keys][0],6000);
