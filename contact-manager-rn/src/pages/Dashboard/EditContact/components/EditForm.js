    ...
    ActionSheet.show(
      ...
      buttonIndex => {
        try{
          ...
          //   return pickImage();
          // }
          if(BUTTONS[buttonIndex].text=="Select From File Manager")
          {
           return pickImage();
          }
   ...
   * ensure button remains disable until all form fields are filled
   ...
   useEffect(() => 
   {
    ...
    const pickImage = async () => {
      ...
      console.log("This is result.uri: ",result.base64);
...
if (base64Matcher.test(imageElem)) {
 ...
 useEffect(() => {
  ...
  else if(editResponse!="" || editResponse!=null || editResponse!="loading")
  {
    ...
    { 
      ResponseToast("top","Close","success",editResponse.messages,6000);
    ...
    {
        if(typeof editResponse.messages === "string")
        {
          ResponseToast("top","Close","danger",editResponse.messages,6000);

          // console.log(MobileErr);

          // console.log(fields);

        }else if(typeof editResponse.messages === "object")
        {
          Object.keys(editResponse.messages).map((keys,index)=>{
      
            ResponseToast("top","Close","danger",editResponse.messages[keys][0],6000);
